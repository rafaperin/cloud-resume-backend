...
- The Microsoft Entra object ID of the user who uploads frontend files

Retrieve the signed-in user's object ID:
...
az deployment sub what-if \
  ...
  --parameters main.bicepparam deployerPrincipalId=<user-object-id>
~~~
